...
const RecentProjects = () => {
    return (
        <div className="py-20" id="projects">
            ...
            <div className="flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-14 mt-10">
                {projects.map(({id, title, des, iconLists, img, link
                }) => (
                   <div key={id} className="sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] flex items-center justify-center sm:w-[570px] w-[80vm]">
